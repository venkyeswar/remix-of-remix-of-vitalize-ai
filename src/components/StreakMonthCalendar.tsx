    ...
    <div>
      <header className="mb-4 flex items-center justify-between">
        <button
          ...
          className="grid h-9 w-9 place-items-center rounded-full border border-border/60 hover:bg-accent"
      ...
      <DayPicker
        ...
        classNames={{
          ...
          week: "grid grid-cols-7 gap-1.5 mb-1.5",
          day: "aspect-square",
          day_button: cn(
            "w-full h-full rounded-lg border border-border/40 bg-muted/30 text-xs font-medium",
